  ...
  <section class="seo__home center-content l-container">
      <article class="">
        ...
        <div class="l-section seo__home--sub-title center-block">
            <h2 class="seo-title">¿Qué es <span class="color-home-title-2">SEO</span> y cómo funciona?</h2>
...
<section class="web__home__sec-1 l-section l-container center-content">
    ...
    <div class="web__home__sec-1--items">
        ...
        <article class="l-section item-2">
            ...
            <ul class="list__web-method left-content m-b">
                <li class="list__web-method--items icon-check">Reunión en persona, correo electrónico o video llamada para iniciar las ideas y  objetivos de la     empresa.</li>
                <li class="list__web-method--items  icon-check">Presentación de propuesta siguiendo las ideas iniciales.</li>
                <li class="list__web-method--items  icon-check">Hacemos una arquitectura de la información.</li>
                <li class="list__web-method--items  icon-check">Hacemos una arquitectura web y estructuración del contenido.</li>
                <li class="list__web-method--items  icon-check">Optimización de la página con los estándares de posicionamiento web - SEO.</li>
                <li class="list__web-method--items  icon-check">Maquetación web adaptada a móviles, tablets, portátil y ordenadores de escritorio.</    li>
                <li class="list__web-method--items  icon-check">Presentación del diseño.</li>
                <li class="list__web-method--items  icon-check">Feedback del cliente para últimos retoques de acuerdo a la propuesta aprobada   previamente.</li>
